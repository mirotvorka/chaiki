...
function generate() {
    ...
    let stream = document.getElementById("stream").value || "Текст.";

    news = news.replace(/●/g, "•");
    news = news.replace(/○/g, "∘");

    let authorId = (document.getElementById("authorId")?.value || "").trim();
